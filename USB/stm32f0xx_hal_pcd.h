...
#define PCD_SET_ENDPOINT(USBx, bEpNum, wRegValue) \
  (*(volatile uint16_t *)(&(USBx)->EP0R + ((bEpNum) * 2U)) = (uint16_t)(wRegValue))
...
#define PCD_SET_EP_TX_ADDRESS(USBx, bEpNum, wAddr) \
  do { \
    volatile uint16_t *_wRegVal; \
    uint32_t _wRegBase = (uint32_t)USBx; \
    \
    _wRegBase += (uint32_t)(USBx)->BTABLE; \
    _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + (((uint32_t)(bEpNum) * 8U) * PMA_ACCESS)); \
    *_wRegVal = ((wAddr) >> 1) << 1; \
...
#define PCD_SET_EP_RX_ADDRESS(USBx, bEpNum, wAddr) \
  do { \
    ...
    \
    _wRegBase += (uint32_t)(USBx)->BTABLE; \
    _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum) * 8U) + 4U) * PMA_ACCESS)); \
    *_wRegVal = ((wAddr) >> 1) << 1; \
...
#define PCD_SET_EP_RX_DBUF0_CNT(USBx, bEpNum, wCount) \
  do { \
    uint32_t _wRegBase = (uint32_t)(USBx); \
    volatile uint16_t *pdwReg; \
    \
    _wRegBase += (uint32_t)(USBx)->BTABLE; \
    pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum) * 8U) + 2U) * PMA_ACCESS)); \
...
#define PCD_SET_EP_TX_CNT(USBx, bEpNum, wCount) \
  do { \
    ...
    \
    _wRegBase += (uint32_t)(USBx)->BTABLE; \
    _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum) * 8U) + 2U) * PMA_ACCESS)); \
...
#define PCD_SET_EP_RX_CNT(USBx, bEpNum, wCount) \
  do { \
    ...
    \
    _wRegBase += (uint32_t)(USBx)->BTABLE; \
    _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(bEpNum) * 8U) + 6U) * PMA_ACCESS)); \
  ...
  do { \
    ...
    { \
      ...
      { \
        ...
        _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)(bEpNum) * 8U) + 6U) * PMA_ACCESS)); \
